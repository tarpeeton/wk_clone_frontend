...
const Feed: FC = () => {
	return (
		<div className='flex flex-row gap-[5%]'>
			<div className='w-[55%] pt-[15px]'>
				<div className='NewHistory rounded-lg flex items-center'>
					<div className='w-[10%] rounded-[100%] flex justify-end'>
						<img
