							...
							<div className='w-full flex gap-4 mt-3 NotificationMenuItem'>
								...
								<div className='flex-col w-4/5'>
									<div className='feedback_header Font13Header'>
										...
										<span className='rel_date'>сегодня в 3:24</span> через сайт
										«ВКонтакте», Ташкент. Нажмите «Подробнее», чтобы посмотреть
						...
						<MenuItem>
							<div className='w-full flex text-center'>
								<NavLink
									...
									className='w-full p-2 NotificationMenuItem ShowNotification'
								>
									Показать все
								</NavLink>
							</div>
